...
const rectangle2 = new Rectangle(500, 700);
...
const student2 = new Student('Iryna', 41, 7)
...
const book2 = new Book('Ten little Niggers', 'Agatha Christie', 1939);
...
const account2 = new BankAccount(7, 355);
...
const animal2 = new Animal('name', 'sound');
...
const person2 = new Person('Ira', 41, "New York" );
...
/*class Employee {
  ...
  const bonusAmount = this.salary * (bonus / 100);
	return this.salary + bonusAmount;
	}
}

const employee2 = new Employee('Iryna', 7000);
